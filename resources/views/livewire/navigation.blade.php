<nav class="bg-gray-800" x-data="{ open: false }">
    <div class="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
        <div class="relative flex h-16 items-center justify-center sm:justify-between">
            <!-- Mobile menu button-->
            ...
            <div class="hidden sm:ml-6 sm:block">
                <div class="flex justify-center space-x-4">
                    ...
                    <a href="{{route('admin.home')}}" class="bg-gray-900 text-white rounded-md px-3 py-2 text-sm font-medium hover:shadow-md hover:shadow-indigo-500" aria-current="page">Dashboard</a>
                    <a href="{{route('admin.bills.index')}}" class="bg-gray-900 text-white rounded-md px-3 py-2 text-sm font-medium hover:shadow-md hover:shadow-indigo-500" aria-current="page">Cotizaciones</a>
                    <a href="{{route('admin.clientes.index')}}" class="bg-gray-900 text-white rounded-md px-3 py-2 text-sm font-medium hover:shadow-md hover:shadow-indigo-500" aria-current="page">Clientes</a>
                </div>
            </div>
