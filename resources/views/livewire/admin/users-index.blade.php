    ...
    <div class="scroll-container overflow-x-auto">
        ...
        <div class="grid grid-flow-col grid-cols-12 bg-blanco text-oscuro p-5 border-claro border-b-[1px] w-[640px] md:w-full">
            ...
            <div class="col-span-2 lg:col-span-2 pr-4 flex flex-row">
                ...
                <a href="{{route('admin.users.edit', $cliente)}}" class="hover:text-principal hover:blur-[0.6px] pb-1 mr-6"><i class="ri-edit-line text-xl"></i></a>
                @endcan

                @can('admin.users.destroy')
                <form action="{{route('admin.users.destroy', $cliente)}}" method="POST" class="hover:blur-[0.6px]">
                    @csrf
                    @method('delete')
