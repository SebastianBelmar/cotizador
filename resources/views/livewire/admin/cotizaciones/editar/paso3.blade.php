...
{{-- modal --}}
@include("livewire.admin.cotizaciones.editar.modales.open3")


@include("livewire.admin.cotizaciones.editar.modales.nuevo3")

@include("livewire.admin.cotizaciones.editar.modales.ver3")

@include("livewire.admin.cotizaciones.editar.modales.edit3")