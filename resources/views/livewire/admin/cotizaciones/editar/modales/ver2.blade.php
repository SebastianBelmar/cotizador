<x-dialog-modal-cotizacion wire:model="ver2">
    ...
    <x-slot name="content" >
        <div x-data="{datosProductos: @entangle('datosProductos') }"
            ...
            <div class="border-medioClaro border-t-2 flex flex-col items-center justify-center p-4 w-full" x-data="{opcion: @entangle('opcion')}">
            ...
            <div class=" flex flex-col items-center justify-center p-4 w-full">
                @if($descuento)
                    <p class="font-light">Precio Final aplicando <span class="font-semibold">Descuento del {{number_format($descuento, 0, ',', '.')}}%</span></p>
