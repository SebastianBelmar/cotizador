...
{{-- modal --}}
@include("livewire.admin.cotizaciones.editar.modales.open4")

@include("livewire.admin.cotizaciones.editar.modales.nuevo4")

@include("livewire.admin.cotizaciones.editar.modales.ver4")

@include("livewire.admin.cotizaciones.editar.modales.edit4")