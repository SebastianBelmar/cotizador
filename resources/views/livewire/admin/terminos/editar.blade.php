<x-dialog-modal-cotizacion wire:model="editar">
    ...
    <x-slot name="title" >
        <div class="bg-blanco w-full py-4 rounded-t-3xl border-principal border-b-4 grid grid-cols-12 gap-4 px-6 lg:px-12">
            <div class="col-span-11 flex flex-col items-center justify-center my-auto">
                <p class="text-2xl text-oscuro font-semibold">Editando término</p>
            </div>
    ...
    <x-slot name="content" >
        <div class="font-semibold text-oscuro rounded-b-3xl h-full w-full mx-auto mb-0"
        >
    ...
    <x-slot name="footer">
        <div class="bg-blanco w-full py-2 rounded-b-3xl px-6">
            <div class=" w-full grid grid-cols-2 gap-4 my-6">
                <button wire:click="$set('editar', false);"
                ...
                <button
                    ...
                    wire:click="guardarTerminoEditado"
                >
                    GUARDAR
                </button>
            </div>
