    ...
    <div class="w-full flex lg:flex-row flex-col mt-8" x-data="{busqueda : @entangle('search').defer, close: false}">
        ...
        @can('admin.clientes.create')
            ...
            <div class="mb-6 lg:mb-0 h-20 order-1 lg:order-2 ">
                <a href="{{route('admin.clientes.create')}}" class="bg-principal lg:w-[360px] w-full h-20 rounded-2xl flex justify-between items-center px-12 shadow-sm shadow-sombra hover:bg-blanco hover:text-principal text-blanco hover:ring-2 ring-principal">
