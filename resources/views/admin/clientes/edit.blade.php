    ...
    <div class="w-10/12 min-w-[480px] max-w-[1920px] h-full mx-auto bg-claro mt-8">
        ...
        <div class="bg-blanco w-full p-6 rounded-t-3xl border-principal border-b-4 grid grid-cols-12 gap-4 px-6 lg:px-12">
            ...
            <div class="col-span-10 flex flex-col items-center justify-center my-auto">
                <p class="text-2xl text-oscuro font-semibold">Editar Cliente</p>
            </div>
        ...
        <div class="bg-blanco w-full p-4 px-6 lg:px-12 rounded-b-3xl">
            ...
            <div class="bg-blanco w-full  pt-8  rounded-b-3xl border-t border-medioClaro mb-6">
                {!! Form::submit('Actualizar Cliente', ['class' => 'w-full bg-principal text-xl lg:text-2xl font-semibold border-principal border-2  rounded-xl text-blanco hover:text-principal hover:bg-blanco hover:border-2 hover:border-principal py-4 cursor-pointer']) !!}
            </div> 
            {!! Form::close()!!}
        </div>    
